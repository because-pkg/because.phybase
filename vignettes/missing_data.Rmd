---
title: "Phylogenetic Missing Data Imputation"
...
We will artificially introduce missing values (`NA`) into the dataset to demonstrate how `because` handles them. We'll add missingness to: 
...
We define the same structural equation model (sem8) as in the previous [vignette](03_phylogenetic_model.html): \* Body Mass (`BM`) affects Litter Size (`LS`) and Nose
